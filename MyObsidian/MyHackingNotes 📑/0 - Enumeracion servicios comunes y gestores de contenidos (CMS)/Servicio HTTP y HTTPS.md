...
#sslscan
sslscan tinder.com
# este es mucho mejor y nos muestra vulnerabilidades
```
...
El contenedor vulnerable que desplegamos en vulnerable al heartbleed y podemos verlo de la siguiente manera:

```bash
# primero lo vemos con sslscan 
...
# y luego con un script de nmap
❯ nmap --script ssl-heartbleed -p8443 127.0.0.1
Starting Nmap 7.94 ( https://nmap.org ) at 2024-01-16 01:12 -03
...
Luego mediante un script de python con el que veremos si podemos robar informacion privilegiada `python3 ssltest.py 127.0.0.1:8443 2`