...
---
---
Asi va quedando el dockerfile
```d
  1 FROM ubuntu:latest
  2 
  3 MAINTAINER agus "elagussepulveda@gmail.com"
  4 
  5 ENV DEBIAN_FRONTEND noninteractive
  6 
  7 RUN apt update && apt install -y net-tools \
  8     iputils-ping \
  9     curl \
 10     git \
 11     nano \
 ...
 13     php
 14 
 15 COPY prueba.txt /var/www/html #nos sirve para copiar de local al contenedor
 16  
 17 EXPOSE 80
 18 
...
para borrar todos las imágenes que estén como none que no sirven para nd las borramos de la siguiente manera
...
La ruta donde esta el archivo index es /var/www/html
